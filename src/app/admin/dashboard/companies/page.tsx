...
export default function CompaniesPage() {
  ...
  useEffect(() => {
    ...
    } else if (user && user.role !== "superadmin" && !loading) {
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight mb-2">
              Registered Companies & Platforms
            </h1>
            <p className="text-white/80 text-sm sm:text-base max-w-xl leading-relaxed">
              Global overview of all onboarded companies, registered website domains, and platform configurations.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-5">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-[#11253e] mt-1">2</p>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-green-600 mt-1">99.9%</p>
          </div>
          <div className="w-11 h-11 bg-green-50 text-green-600 rounded-xl flex items-center justify-center font-bold">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-[#f99d1c] mt-1">Super Admin</p>
          </div>
                  ...
                  <td colSpan={7} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-xs mt-1">Click &ldquo;Add Company&rdquo; to get started.</p>
                      </div>
                    </div>
                  </td>
                </tr>
                  ...
                  <tr key={company._id} className="hover:bg-gray-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {company.description && (
                            <p className="text-[11px] text-gray-400 mt-0.5 max-w-[180px] truncate">{company.description}</p>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-1">
                        <a
                          href={`/admin/dashboard/companies/${company._id}/websites`}
                          className="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-xl transition-all flex items-center gap-1.5 text-xs font-bold mr-1 shadow-sm"
                          title="Manage Company Websites & CRM Configs"
                        >
                          <Globe size={13} />
                          Manage Websites
                        </a>
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-[#11253e]/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-[#11253e] text-lg">Delete Company?</h3>
                <p className="text-gray-500 text-sm mt-1">
                  This will permanently remove{" "}
                  <span className="font-semibold text-[#11253e]">{deleteTarget.name}</span>. This
