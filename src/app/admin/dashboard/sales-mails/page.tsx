    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#11253e]">
            Sales Mails (Brochures)
          </h1>
          <p className="text-gray-500 text-sm mt-1">
            Tracking {filteredMails.length} brochure requests from solutions
            pages.
          </p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                ...
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider text-center w-24">
                  Action
                </th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                <tr>
                  ...
                  >
                    ...
                    <p className="text-sm">
                      No brochure requests found matching your search.
                    </p>
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-bold text-[#11253e] text-sm">
                            {item.name}
                          </p>
      ...
      {selectedMail && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div
            className="absolute inset-0 bg-[#11253e]/80 blur-sm"
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium text-[#11253e]">
                    {selectedMail.name}
                  </p>
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-4 pt-6 border-t border-gray-50">
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium text-[#f99d1c]">
                    {selectedMail.pageTitle}
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                  ...
                  <div
                    ...
                    onClick={() => window.open(selectedMail.pageUrl, "_blank")}
                  >
                    <p className="text-sm font-medium text-[#11253e] truncate flex-1">
                      {selectedMail.pageUrl}
                    </p>
                    <ExternalLink
                      size={14}
                      className="text-[#f99d1c] opacity-0 group-hover:opacity-100 transition-opacity"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 bg-[#f99d1c]/5 rounded-xl border border-[#f99d1c]/10">
                ...
                <div>
                  <p className="text-xs font-bold text-[#11253e]">
                    Solution Brochure Requested
                  </p>
                  <p className="text-[10px] text-gray-500">
                    Automated email with PDF link was triggered.
                  </p>
                </div>
              </div>
            </div>
